...
JSON_STRING=$(cat <<-END
{"schemaVersion": 1, "label": "installations", "message": "installations", "body": $(curl -s https://api.countapi.xyz/info/dropboxignore.simakis.me/total | jq -r .value), "color": "blue"}
END
)
